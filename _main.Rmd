...
Now by default the Twitter API responses are in [JSON format](https://en.wikipedia.org/wiki/JSON). We can use the jsonlite package to translate the JSON-formatted string into an R object with
...
<!--chapter:end:01-first-steps.Rmd-->
